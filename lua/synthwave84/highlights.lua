local c = require("synthwave84.palette")

local hl = vim.api.nvim_set_hl
local theme = {}

theme.set_highlights = function(cfg)
	-- Editor
	...
	hl(0, "ErrorMsg", { fg = c.error, bg = c.bg, bold = cfg.error_msg })
	...
	hl(0, "Boolean", { fg = c.peach, bg = "NONE" })
	hl(0, "Constant", { fg = c.purple, bg = "NONE" })
	hl(0, "Type", { fg = c.red, bg = "#342532", bold = cfg.type2 })
	hl(0, "Function", { fg = c.cyan, bg = "#262d3f", bold = cfg.func })
	hl(0, "Keyword", { fg = c.yellow, bg = "#312c37", bold = cfg.keyword, italic = true })
	hl(0, "Conditional", { fg = c.yellow, bg = "NONE", italic = true })
	hl(0, "Repeat", { fg = c.yellow, bg = "NONE" })
	if cfg.operator then
		hl(0, "Operator", { fg = "#fede5d", bg = "#312c37", bold = true })
	else
		hl(0, "Operator", { fg = "#fede5d", bg = "NONE" })
	end
	hl(0, "PreProc", { fg = c.purple, bg = "NONE" })
	hl(0, "Include", { fg = c.green, bg = "NONE", italic = true })
	hl(0, "Exception", { fg = c.green, bg = "NONE", italic = true })
	hl(0, "StorageClass", { fg = c.red, bg = "NONE" })
	hl(0, "Structure", { fg = c.red, bg = "NONE" })
	hl(0, "Typedef", { fg = c.green, bg = "NONE" })
	hl(0, "Define", { fg = c.green, bg = "NONE", italic = true })
	hl(0, "Macro", { fg = c.green, bg = "NONE" })
	hl(0, "Debug", { fg = c.red, bg = "NONE" })
	hl(0, "Title", { fg = c.blue, bg = "NONE", bold = cfg.title })
	hl(0, "Label", { fg = c.fg, bg = "NONE" })
	hl(0, "SpecialChar", { fg = c.orange, bg = "NONE", italic = true })
	hl(0, "Delimiter", { fg = c.alt_fg, bg = "NONE" })
	hl(0, "SpecialComment", { fg = c.alt_fg, bg = "NONE", italic = true })
	hl(0, "Tag", { fg = c.green, bg = "NONE" })
	hl(0, "Bold", { fg = "NONE", bg = "NONE", bold = cfg.bold })
	...
	hl(0, "TSKeywordFunction", { fg = c.green, bg = "NONE" })
	...
	hl(0, "TSTagDelimiter", { fg = c.blue, bg = "NONE" })
	...
	hl(0, "TSParameter", { link = "Variable" })
	hl(0, "TSParameterReference", { link = "Variable" })
	hl(0, "TSAttribute", { link = "Variable" })
	...
	hl(0, "BufferCurrentTarget", { fg = c.red, bg = c.bg, bold = cfg.buffer_current_target })
	...
	hl(0, "BufferVisibleTarget", { fg = c.red, bg = c.bg, bold = cfg.buffer_visible_target })
	...
	hl(0, "BufferInactiveTarget", { fg = c.red, bg = c.alt_bg, bold = cfg.buffer_inactive_target })
